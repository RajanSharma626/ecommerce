        ...
        <div class="header__topbar bg__secondary">
            <div class="container-fluid">
                <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                    <div class="header__shipping m-auto">
                        <ul class="header__shipping--wrapper d-flex text-center">
                            <li class="header__shipping--text text-white">Welcome to Trift Point online Store</li>
                    </div>
                ...
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.php"
                                style="width: 100px;"><img class="main__logo--img" src="assets/img/logo/TM logo.PNG"
                                    alt="logo-img"></a></h1>
                    </div>
                        ...
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items mega__menu--items style2">
                                    <a class="header__menu--link" href="shop.html">Mens</a>
                                </li>
                                <li class="header__menu--items style2 d-none d-xl-block">
                                    <a class="header__menu--link" href="shop.html">Womens </a>
                                </li>
                                <li class="header__menu--items style2 d-none d-xl-block">
                                    <a class="header__menu--link" href="shop.html">Anime </a>
                                </li>
                                <li class="header__menu--items style2">
                                    <a class="header__menu--link" href="#">Accessories
                                    ...
                                    <ul class="header__sub--menu">
                                        <li class="header__sub--menu__items"><a href="about.html"
                                                class="header__sub--menu__link">Coffe Mugs</a></li>
                                    </ul>
                                </li>
                                <li class="header__menu--items style2">
                    ...
                    <div class="header__menu">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items mega__menu--items">
                                    <a class="header__menu--link" href="shop.html">Animes</a>
                                </li>
                                <li class="header__menu--items style2">
                                    <a class="header__menu--link" href="#">Accessories
                                        <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12"
                                    ...
                                    <ul class="header__sub--menu">
                                        <li class="header__sub--menu__items"><a href="about.html"
                                                class="header__sub--menu__link">Coffee Mugs</a></li>
                                    </ul>
                                </li>
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="contact.php">Contact Us</a>
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.php">
                        <img src="assets/img/logo/TM logo.PNG" alt="Grocee Logo" width="158" height="36">
                    </a>
                ...
                <nav class="offcanvas__menu">
                    <ul class="offcanvas__menu_ul">
                        ...
                        <li class="offcanvas__menu_li">
                            <a class="offcanvas__menu_item" href="#">Mens</a>
                        </li>
                        <li class="offcanvas__menu_li">
                            <a class="offcanvas__menu_item" href="#">Womens</a>
                        </li>
                        <li class="offcanvas__menu_li"><a class="offcanvas__menu_item" href="about.html">Accessories</a>
                            <ul class="offcanvas__sub_menu">
                                <li class="offcanvas__sub_menu_li"><a href="index.php" class="offcanvas__sub_menu_item">Coffee Mugs</a></li>
                            </ul></li>
                        <li class="offcanvas__menu_li"><a class="offcanvas__menu_item" href="contact.php">Contact
                                Us</a>
                        </li>
                    </ul>
