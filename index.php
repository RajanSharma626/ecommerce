...
<body>
    ...
    <main class="main__content_wrapper">
                ...
                <div class="hero__slider--wrapper swiper-wrapper">
                    ...
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home1__slider--bg">
                            <a href="">
                                <img class="slider__text--shape__icon" src="assets/img/banner/June-Desktop-Banner.jpg"
                                    alt="text-shape-icon">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home1__slider--bg two">
                            <a href="">
                                <img class="slider__text--shape__icon" src="assets/img/banner/Geek-New-Banner.jpg"
                                    alt="text-shape-icon">
                            </a>
                        </div>
                    </div>
        ...
        <section class="banner__section section--padding pb-3">
            <div class="container">
                <div class="row mb--n28">
                    <div class="col-lg-6 mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.php?cat=huddies"><img
                                    class="banner__items--thumbnail__img banner__img--max__height"
                                    src="assets/img/banner/Hoodies-1.jpg" alt="banner-img">
                    ...
                    <div class="col-lg-6 mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.php?cat=sweat-shirt"><img
                                    class="banner__items--thumbnail__img banner__img--max__height"
                                    src="assets/img/banner/Sweatshirt.jpg" alt="banner-img">
                                <!-- <div class="banner__items--content">
                                        <span class="banner__items--content__subtitle">25% Discount</span>
                                        <h2 class="banner__items--content__title h3">Leather Saddle <br>
                                            Bag Style</h2>
        ...
        <!-- Start banner section -->
        <section class="banner__section section--padding pt-0 pb-3">
            <div class="container">
                <div class="row mb--n28 justify-content-center">
                    <div class="col-lg-6 col-6 col-md-order mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative"
                                href="shop.php?cat=oversize-tshirt"><img class="banner__items--thumbnail__img"
                                    src="assets/img/banner/Oversized.jpg" alt="banner-img">
                                <!-- <div class="banner__items--content">
                    ...
                    <div class="col-lg-6 col-6 mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative"
                                href="shop.php?cat=half-sleeves-tshirt"><img class="banner__items--thumbnail__img"
                                    src="assets/img/banner/Half-Sleeve-2.jpg" alt="banner-img">
                                <!-- <div class="banner__items--content">
                ...
                <div class="row row-cols-md-2 row-cols-1 mb--n28">
                    <div class="col-12 mb-28">
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail " href="shop.php?cat=coffe-mugs"><img
                                    class="banner__items--thumbnail__img banner__img--max__height"
                                    src="assets/img/banner/Coffee-Mug-1536x768.jpg" alt="banner-img">
                                <!-- <div class="banner__items--content">
            ...
            <div class="container">
                <div class="row mb--n28 justify-content-center">
                    <div class="col-lg-6 col-6 mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative"
                                href="shop.php?cat=anime-tshirts"><img class="banner__items--thumbnail__img"
                                    src="assets/img/banner/Anime-Oversized-10.png" alt="banner-img">
                                <!-- <div class="banner__items--content">
                    ...
                    <div class="col-lg-6 col-6 mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.php?cat=active-wear"><img
                                    class="banner__items--thumbnail__img" src="assets/img/banner/Active-Wears.jpg"
                                    alt="banner-img">
                                <!-- <div class="banner__items--content">
                                            <span class="banner__items--content__subtitle">Shop Women</span>
                                            <h2 class="banner__items--content__title h3">Free Shipping Over <br>
