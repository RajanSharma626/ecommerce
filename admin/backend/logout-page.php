...
<!-- Mirrored from themesbrand.com/toner/html/backend/auth-logout-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Oct 2023 16:32:59 GMT -->
<head>

        <meta charset="utf-8">
        <title>Log Out | Trift Point</title>
                            ...
                            <div class="auth-card mx-lg-3">
                                <div class="card border-0 mb-0">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <p class="text-muted fs-15">Thank you for using <span class="fw-semibold">Trift Point</span> Admin Panel</p>

                                        <div>
                                            <a href="admin-login.php" class="btn btn-primary w-100">Log In</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="text-center">
                                    <p class="mb-0 text-muted">©
                                        <script>document.write(new Date().getFullYear())</script> Trift Point. Crafted with <i class="mdi mdi-heart text-danger"></i> by <a href="https://rajansharma-portfolio.netlify.app/" target="_blank">Rajan Sharma</a>
                                    </p>
                                </div>
                            </div>
                        </div>
