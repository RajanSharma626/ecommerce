    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="index.php" class="nav-link menu-link"> <i class="bi bi-speedometer2"></i> <span
                            data-key="t-dashboard">Dashboard</span> <span
                            class="badge badge-pill bg-danger-subtle text-danger " data-key="t-hot">Hot</span></a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarProducts">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="product-create.html" class="nav-link" data-key="t-create-product">Create
                                    Product</a>
                            </li>
                            <li class="nav-item">
                                <a href="categories.php" class="nav-link" data-key="t-categories">Categories</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="users-list.html" class="nav-link menu-link"> <i class="bi bi-person-bounding-box"></i>
                        <span data-key="t-users-list">Users
                            List</span> </a>
                </li>
