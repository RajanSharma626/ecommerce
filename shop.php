...
if (isset($_GET['cat']) && $_GET['cat']) {
    $cat = $_GET['cat'];
    $checkCat = mysqli_query($conn, "SELECT * FROM `categories` WHERE `slug` = '$cat'");
    $category = mysqli_fetch_assoc($checkCat);
                            ...
                            <div class="tab_content">
                                <div id="product_grid" class="tab_pane active show">
                                    <div class="product__section--inner product__grid--inner">
                                        ...
                                        <?php
                                        $caId = $category['id'];
                                        $productSql = mysqli_query($conn, "SELECT * FROM `product` WHERE `publish` = 1 AND `categories_id` ='$caId' ");
                                        while ($row = mysqli_fetch_assoc($productSql)) {
                                            ?>
                                                        <div class="col mb-30">
                                                            <div class="product__items ">
                                                                <div class="product__items--thumbnail">
                                                                    <a class="product__items--link" href="product-details.php?id=<?php echo $row['id']?>">
                                                                        <img class="product__items--img product__primary--img" src="admin/assets/images/products/<?php echo $row['img']?>" alt="product-img">
                                                                ...
                                                                <div class="product__items--content">
                                                                    ...
                                                                    <h3 class="product__items--content__title h4"><a href="product-details.php?id=<?php echo $row['id']?>"><?php echo $row['name'] ?></a></h3>
                                                                    <div class="product__items--price">
                                                                        <span class="current__price"><?php echo $row['price']?>₹</span>
                                                                        <span class="price__divided"></span>
                                                                        <span class="old__price"><?php echo $row['mrp']?>₹</span>
                                                                    </div>
                                                      <ul class="rating product__rating d-flex">
                                                                        <li class="rating__list">
                                                                            <span class="rating__list--icon">
