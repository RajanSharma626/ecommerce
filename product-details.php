...
if (isset($_GET['id']) && $_GET['id']) {
    $id = $_GET['id'];
    $checkProduct = mysqli_query($conn, "SELECT * FROM `product` WHERE `id` = '$id'");
    $product = '';
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="admin/assets/images/products/<?php echo $product['img'] ?>"><img class="product__media--preview__items--img" src="admin/assets/images/products/<?php echo $product['img'] ?>" alt="product-media-img"></a>
                                            <!-- <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="admin/assets/images/products/<?php echo $product['img'] ?>" data-gallery="product-media-preview">
                                    ...
                                    $ProductImgSql = mysqli_query($conn, "SELECT * FROM `product_img` WHERE `product_id`='$productId'");
                                    while ($row = mysqli_fetch_assoc($ProductImgSql)) {
                                        ?>
                                                <div class="swiper-slide">
                                                    <div class="product__media--preview__items">
                                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="admin/assets/images/products/<?php echo $row['img'] ?>"><img class="product__media--preview__items--img" src="admin/assets/images/products/<?php echo $row['img'] ?>" alt="product-media-img"></a>
                                                        <!-- <div class="product__media--view__icon">
                                                            <a class="product__media--view__icon--link glightbox" href="admin/assets/images/products/<?php echo $row['img'] ?>" data-gallery="product-media-preview">
                                                                <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                            </a>
                                                        </div> -->
                                                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="admin/assets/images/products/<?php echo $product['img'] ?>" alt="product-nav-img">
                                        </div>
                                    </div>
                                    ...
                                    while ($row = mysqli_fetch_assoc($ProductImgSql)) { ?>
                                                <div class="swiper-slide">
                                                    <div class="product__media--nav__items">
                                                        <img class="product__media--nav__items--img" src="admin/assets/images/products/<?php echo $row['img'] ?>" alt="product-nav-img">
                                                    </div>
                                                </div>
                                    <?php } ?>
                        ...
                        <div class="product__details--info">
                            <form action="#">
                                ...
                                <div class="product__details--info__price mb-10">
                                    <span class="current__price"><?php echo $product['price'] ?>₹</span>
                                    <span class="price__divided"></span>
                                    <span class="old__price"><?php echo $product['mrp'] ?>₹</span>
                                </div>
                                ...
                                <p class="product__details--info__desc mb-15"><?php echo $product['short_desc'] ?></p>
                                <div class="product__variant">
                                    <div class="product__variant--list mb-10">
                                        <fieldset class="variant__input--fieldset">
                                            <legend class="product__variant--title mb-8">Color :</legend>
                                            <input id="color-red1" name="color" type="radio" checked>
                                            <label class="variant__color--value red" for="color-red1" title="Red"></label>
                                            <input id="color-red2" name="color" type="radio">
                                            <label class="variant__color--value red" for="color-red2" title="Black"></label>
                                            <input id="color-red3" name="color" type="radio">
                                            <label class="variant__color--value red" for="color-red3" title="Pink"></label>
                                            <input id="color-red4" name="color" type="radio">
                                            <label class="variant__color--value red" for="color-red4" title="Orange"></label>
                                        </fieldset>
                                    </div>
                                    <div class="product__variant--list mb-15">
                                        <fieldset class="variant__input--fieldset weight">
                                            ...
                                            foreach ($size as $sizes) {
                                                ...
                                                <label class="variant__size--value red" for="weight1"><?php echo strtoupper($sizes) ?></label>
                                                <?php $no++;
                                            } ?>
                                        </fieldset>
                                    </div>
                                    ...
                                    <!-- <div class="product__details--info__meta">
                                        <p class="product__details--info__meta--list"><strong>Product :</strong>  <span>565461</span> </p>
                                ...
                                <div id="description" class="tab_pane active show">
                                    <div class="product__tab--content">
                                        <div class="product__tab--content__step mb-30">
                                            <h2 class="product__tab--content__title h4 mb-10"><?php echo $product['name'] ?></h2>
                                            <p class="product__tab--content__desc"><?php echo $product['description'] ?></p>
                                        </div>
                                    </div> 
                                </div>
...
<!-- Mirrored from risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 18:18:42 GMT -->
</html>